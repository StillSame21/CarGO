DROP PROCEDURE IF EXISTS ensure_cancelled_booking_status;

DELIMITER //

CREATE PROCEDURE ensure_cancelled_booking_status()
BEGIN
    ...
    IF current_column_type IS NOT NULL
       AND LOCATE('''cancelled''', current_column_type) = 0 THEN
...
CALL ensure_cancelled_booking_status();
DROP PROCEDURE ensure_cancelled_booking_status;
